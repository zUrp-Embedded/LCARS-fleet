...
Search in: `fleet/`, `.claude/hooks/`, `*.sh`, `fleet/provisioning/deploy.sh`

**Group B — Provisioning coherence**
Look for:
- Discrepancies between `fleet/provisioning/provision-system.sh`, `fleet/provisioning/provision-users.sh`, and `fleet/provisioning/deploy.sh`
...
Search in: `fleet/provisioning/`, `docs/`
