defmodule Fleet.Observation.Deck.View do
  ...
  def page do
    ...
    function podCard(p){
      ...
      // runtime), `role_icon` est la reponse a « quel asset existe ». Un role sans `.svg` mis a
      // `null` cote API tomberait ici sur le generique — rendu correct, et `/api/pods` mentant a
