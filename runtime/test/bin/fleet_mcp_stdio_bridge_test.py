#!/usr/bin/env python3
# SOURCE: runtime/test/bin/fleet_mcp_stdio_bridge_test.py
...
# schema-shaped here to test — see the Elixir side (test/fleet/mcp/pod_socket_test.exs).
# Run: python3 runtime/test/bin/fleet_mcp_stdio_bridge_test.py  (exit 0 = pass).
import json
import os
import socketserver
import subprocess
...
# now, covered on the Elixir side by test/fleet/mcp/pod_socket_test.exs (tools/list = base + role tools, deftool as
