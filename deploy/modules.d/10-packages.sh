...
check() {
  ...
  if [[ "$pkg_absent" -eq 0 ]]; then
    ...
    # userns : la sonde échoue là où la boîte, une fois bootée, réussit. Mesure du 2026-09-04, premier
    # build avec verify. `PROV_KERNEL_PROBES=0` dit « pas de vérité ici » ; le check le DIT au lieu
