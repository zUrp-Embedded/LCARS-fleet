...
setup() {
  ...
  cp "$RACINE_REELLE/runtime/services/lib/facts.sh" "$RACINE_REELLE/runtime/services/lib/uid-bounds.sh" "$RACINE_REELLE/runtime/services/lib/primitives.sh" "$R/runtime/services/lib/"
