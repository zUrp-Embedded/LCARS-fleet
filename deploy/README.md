...
| 63-forge-tokens | any | any | SONDE de la structure (comptes — territoire OpenTofu, instruct-only) + tokens A4 (`deploy/lib/provision-role-tokens.sh`), passwords-file dérivé du seed bootstrap |
