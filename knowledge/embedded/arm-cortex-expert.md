# ARM Cortex-M Expert — Agent Knowledge Base

**Date** : 2026-03-28
**Dernière révision** : 2026-03-28
**Statut** : import externe (MIT)
**Référencé par** : knowledge/embedded/README.md
**Dérivé de** : https://github.com/wshobson/agents — plugin arm-cortex-microcontrollers (MIT)
