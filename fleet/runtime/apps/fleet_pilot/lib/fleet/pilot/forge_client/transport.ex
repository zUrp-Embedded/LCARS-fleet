defmodule Fleet.Pilot.ForgeClient.Transport do
  ...
  source-de-vérité, l'encodage sûr des segments d'URL et la dérivation du login système.
  ...
  Surface INTERNE (`@doc false`) : tout est public pour que `ForgeClient` l'appelle (et pour les
  tests d'encodage), mais ce n'est pas un contrat d'app — pas de caller hors `fleet_pilot`.
