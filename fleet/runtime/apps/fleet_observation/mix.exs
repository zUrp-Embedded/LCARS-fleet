defmodule Fleet.Observation.MixProject do
  ...
  defp deps do
    [
      ...
      # Ring 0 read — catalogue cap-profiles : source des rôles affichés (`/table`, list/0 + load/1).
      {:fleet_cap_profile, in_umbrella: true},
      # Ring 0 bus — abonnement au stream %Fleet.Event{} (read-model BL-026, incrément C).
