defmodule Fleet.SPBuilderTest do
  ...
  setup %{tmp_dir: tmp_dir} do
    ...
    prev_sp = Application.get_env(:fleet_spbuilder, :sp_role_root)
    prev_mod = Application.get_env(:fleet_spbuilder, :modop_root)

    Application.put_env(:fleet_spbuilder, :sp_role_root, sp_role_root)
    Application.put_env(:fleet_spbuilder, :modop_root, modop_root)

    on_exit(fn ->
      Application.put_env(:fleet_spbuilder, :sp_role_root, prev_sp)
      Application.put_env(:fleet_spbuilder, :modop_root, prev_mod)
    end)
