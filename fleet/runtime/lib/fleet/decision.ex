defmodule Fleet.Decision do
  ...
  @moduledoc """
  Verdict VALIDÉ d'une évaluation de gate — valeur partagée **Ring-0** (deps: []).
  ...
  BND-002). En Ring-0, Coord ET Starfleet l'exigent : la frontière Coord n'accepte QUE `%Fleet.Decision{}`,
