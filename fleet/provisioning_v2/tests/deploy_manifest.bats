#!/usr/bin/env bats
# SOURCE: fleet/provisioning_v2/tests/deploy_manifest.bats
# AUTHOR: consultant
# STARDATE: 2026-07-30
...
setup() {
  ...
  mkdir -p "$ROOT/fleet/provisioning_v2/lib" "$ROOT/fleet/runtime/etc"
  cp "$SRC/lib/provision-lib.sh" "$ROOT/fleet/provisioning_v2/lib/"
...
EOF
  ...
  export PROVISION_LIB="$ROOT/fleet/provisioning_v2/lib/provision-lib.sh"
