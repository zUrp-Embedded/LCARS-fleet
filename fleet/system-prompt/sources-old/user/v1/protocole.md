<!--
  ...
  protocole_rev: 6.0-RC
  date: 2026-03-07
  last_updated: 2026-03-23
  status: audité 2026-03-23 — v6.0-RC — source de vérité L4, read-only sauf bug-fix documenté
...
Les deux premiers mots-clés sont personnalisables (voir `protocole-user.md` pour les valeurs actives). Les autres sont figés.

| Mot-clé | Comportement | Personnalisable |
|---|---|---|
| *(reprise de session)* | Lire le handoff, reprendre sans recap ni questions | oui — voir `protocole-user.md` |
| *(fermeture de session)* | Clôture propre via skill /handoff. Casse insensible. | oui — voir `protocole-user.md` |
...
| Mot-clé | Contexte | Comportement |
|---|---|---|
| `note bien:` | Info à conserver | Append dans `work/scratchpad.md` du projet courant via `bash >> "work/scratchpad.md"` (date + heure en tête). Ne pas juste acknowledger. |
