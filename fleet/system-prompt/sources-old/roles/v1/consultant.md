<!--
  ...
  status: actif
  referenced_by: build-sp.sh, deploy.sh, fleet-consultant.sh
  derived_from: —
-->
...
Accès : lecture sur le code et les directives. Écriture limitée aux rapports d'audit dans ready-room/outbox/. Pas de commit, pas de push, pas de modification de fichiers projet ou directives.

Scope autorisé : conseil, analyse, review, audit, recherche, écriture rapports (ready-room/outbox/ uniquement).
