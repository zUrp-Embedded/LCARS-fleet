#!/usr/bin/env bats
# SOURCE: test/install/release_reuse.bats
# AUTHOR: alice
# STARDATE: (posee par /push-github)
# STATUS: bats tests for etc/install.sh — une release n'est reutilisee que si elle ATTESTE la source
#
...
setup() {
  SUT="$BATS_TEST_DIRNAME/../../etc/install.sh"
  [ -f "$SUT" ]
