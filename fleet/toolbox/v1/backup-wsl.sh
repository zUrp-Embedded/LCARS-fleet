...
#     +-----------------------------------------------------------+
#     | MODULE: BACKUP-WSL      | SUBSYSTEM: TOOLBOX / MAINT      |
#     | LICENSE: AGPL-3         | STARDATE: 2026.091              |
#     +-------------------------+---------------------------------+
#     |                                                           |
#     |  Backs up the WSL2 environment to a tar archive.          |
#     |  Exports distro, compresses, checks target space.         |
#     |                                                           |
#     +-----------------------------------------------------------+
#
#     [FR]
...
#
#     [EN]
#     backup-wsl.sh — Backs up the WSL2 environment to a tar archive.
#     Exports distro, compresses, checks target space.
#
#
# --- END HEADER ---
...
# SEC-02: gh-token excluded — gh stores its credentials in hosts.yml after auth
...
mapfile -t INSTANCES < <(fleet_roles)
MISSING_CRITICAL=0
